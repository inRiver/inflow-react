...
| --- | --- | --- |
| Exact version | `@richard-orilla_inriver/inflow@0.1.0` | A frozen package artifact. Once published, it does not change. |
...
| `latest` | `@richard-orilla_inriver/inflow@latest` | General default only after adoption verification. |
...
| --- | --- |
| Complete freeze | `@richard-orilla_inriver/inflow@0.1.0` |
| Safe patch updates only | `~0.1.0` |
| Follow validated React/MUI checkpoint | `@richard-orilla_inriver/inflow@react19-mui6.3` |
| Evaluate upcoming baseline | `@richard-orilla_inriver/inflow@next` or a prerelease package |
| Local theme iteration | `npm link @richard-orilla_inriver/inflow` |
...
Public npm is the primary consumer registry for `@richard-orilla_inriver/inflow`. Internal source control or CI can still live in Azure DevOps or other private infrastructure without changing the release-channel model.
...
git tag -a theme/react19-mui6.3/v0.1.1 -m "@richard-orilla_inriver/inflow 0.1.1 - React 19 / MUI 6.3"
