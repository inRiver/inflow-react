...
const installCode = `npm install @richard-orilla_inriver/inflow@react19-mui6.3 @mui/material@\">=6.3.0 <6.4.0\" @emotion/react @emotion/styled react@^19 react-dom@^19`;
...
npm dist-tag add @richard-orilla_inriver/inflow@0.1.0 latest`;
...
git tag -a theme/react19-mui6.3/v0.1.0 -m "@richard-orilla_inriver/inflow 0.1.0 - React 19 / MUI 6.3"
git push origin theme/react19-mui6.3/v0.1.0

# Recovery/security reference points:
# - npm exact artifact: @richard-orilla_inriver/inflow@0.1.0
# - source hard tag: theme/react19-mui6.3/v0.1.0
# - moving channel: @richard-orilla_inriver/inflow@react19-mui6.3`;
...
npm dist-tag ls @richard-orilla_inriver/inflow`;

const wrapperExtensionCode = `import { styled } from '@mui/material/styles';
import { ThemedChip } from '@richard-orilla_inriver/inflow';
...
const behaviorAdapterCode = `import { ThemedTable, type ThemedTableProps } from '@richard-orilla_inriver/inflow';
...
const colorModeFlagCode = `import { INFLOW_DARK_MODE_ENABLED } from '@richard-orilla_inriver/inflow';`;
...
import { inflowTokens } from '@richard-orilla_inriver/inflow';
...
const releaseTerms = [
  {
    ...
    example: '@richard-orilla_inriver/inflow@0.1.1',
  ...
  },
  {
    ...
    example: '@richard-orilla_inriver/inflow@react19-mui6.3',
...
const dependencyChoices = [
  {
    ...
    example: '@richard-orilla_inriver/inflow@0.1.0',
  ...
  },
  {
    ...
    example: 'npm link @richard-orilla_inriver/inflow',
          ...
          <CardContent>
            <Stack spacing={2}>
              ...
              <Typography variant="body2" color="text.secondary">
                ...
                API. Apps should import from <code>@richard-orilla_inriver/inflow</code>, not from source files,
          ...
          <CardContent>
            <Stack spacing={2}>
              ...
              <Typography variant="body2" color="text.secondary">
                ...
                <code>@richard-orilla_inriver/inflow@0.1.0</code> stay frozen; apps using
                <code>@richard-orilla_inriver/inflow@react19-mui6.3</code> get the latest validated patch for
